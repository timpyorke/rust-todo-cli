...
fn test_next_id() {
    ...
    let tasks = vec![
        Task { id: 1, text: "a".to_string(), done: false },
        Task { id: 3, text: "b".to_string(), done: true },
    ];
...
fn test_save_and_load_tasks() -> Result<()> {
    ...
    let tasks = vec![
        Task { id: 1, text: "Task 1".to_string(), done: false },
        Task { id: 2, text: "Task 2".to_string(), done: true },
    ];
